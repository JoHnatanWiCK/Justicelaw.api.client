...
@section('main')
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide" id="primer-swiper">
                    <div class="text">
                        ...
                        <p>Accede a una red de abogados especializados li stos para ayudarte en cualquier situación legal.
                        </p>
                ...
                <div class="swiper-slide" id="segundo-swiper">
                    <div class="text">
                        ...
                        <p>Descubre cómo nuestros servicios pueden apoyarte en situaciones legales urgentes o planificadas.
                        </p>
                        <a href="ruta-a-informacion-adicional" class="btn">Leer Más</a>
                    </div>
                </div>
                ...
                <div class="swiper-slide" id="tercer-swiper">
                    <div class="text">
                        ...
                        <p>Juan Pérez, con más de 20 años de experiencia en derecho penal y familiar, está aquí para
                            apoyarte.</p>
                ...
                <div class="swiper-slide" id="cuarto-swiper">
                    <div class="text">
                        <h2>Información Importante</h2>
                        <p>Navega por nuestra plataforma para conocer las diversas áreas legales en las que podemos
                            asesorarte.</p>
                        <a href="ruta-a-informacion-adicional" class="btn">Leer Más</a>
                    </div>
                </div>
                <div class="swiper-slide" id="quinto-swiper">
                    <div class="text">
                        <h3>Conéctate con abogados experimentados y encuentra las respuestas que necesitas.</h3>
                        <p>Contamos con una amplia variedad de abogados que se especializan en diferentes ramas del derecho.
                        </p>
                        <a href="ruta-a-informacion-adicional" class="btn">Leer Más</a>
                    </div>
                </div>
    ...
    <div id="container">
        <div id="slider-container">
            <div class="carousel-header">
                ...
                <p class="carousel-description">Explora una variedad de temas legales que te ayudarán a tomar decisiones
                    informadas. Navega entre nuestras guías y descubre más sobre tus derechos.</p>
            </div>
            ...
            <div id="slider">
                ...
                <div class="slide">
                    ...
                    <div class="card">
                        ...
                        <p class="card-description">La guía sobre divorcio brinda información sobre cómo proceder durante la
                            separación matrimonial, incluyendo consejos legales y emocionales.</p>
                    </div>
                </div>
                <div class="slide">
                    ...
                    <div class="card">
                        ...
                        <p class="card-description">Descubre los pasos clave para redactar una carta de despido
                            correctamente. Te explicamos cómo estructurarla, qué detalles legales incluir y cómo manejar
                            esta situación de forma profesional y clara.</p>
                    </div>
                </div>
                <div class="slide">
                    ...
                    <div class="card">
                        ...
                        <p class="card-description">Descubre los pasos clave para manejar un accidente de tráfico, desde la
                            documentación hasta las acciones legales necesarias.</p>
                    </div>
                </div>
                <div class="slide">
                    ...
                    <div class="card">
                        ...
                        <p class="card-description">Aprende a estructurar y redactar un testamento de forma clara y
                            legalmente válida, asegurando que tus deseos sean respetados y evitando futuros conflictos
                            familiares.</p>
                    </div>
                </div>
                <div class="slide">
                    ...
                    <div class="card">
                        ...
                        <p class="card-description">Entiende los aspectos esenciales de la pensión alimenticia, incluyendo
                            cómo solicitarla,
                ...
                <div class="slide">
                    ...
                    <div class="card">
                        ...
                        <p class="card-description">Conoce tus derechos y cómo resolver conflictos comunes en el
    ...
    @push('styles')
        ...
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet"
            integrity="sha384-5YSOQ5KtZq2j9Vc1lYZn3vZ0rUubXsg9F9Z9RkVoThSKg/B0J9cuC0Rf5Gp6ueIa" crossorigin="anonymous">
    @endpush
