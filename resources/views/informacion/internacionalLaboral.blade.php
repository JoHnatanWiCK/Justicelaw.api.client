...
@section('main')
      ...
      <div class="container">
        <div class="news-column">
          <h2 class="titulo-informacion">Derecho Internacional Laboral</h2>
          ...
          <div class="informacion-contenido">
            ...
            <p>
                ...
                El Derecho Internacional Laboral es una rama del derecho que regula las
                relaciones laborales a nivel global. Se centra en la creación de normas
                y principios destinados a proteger los derechos de los trabajadores,
                mejorar las condiciones laborales y promover la justicia social en todo
                ...
                global y los movimientos migratorios laborales.
            </p>

            <h3>Concepto y Objetivo del Derecho Internacional Laboral</h3>

            <p>
                El Derecho Internacional Laboral se refiere a un conjunto de normas, tratados y
                convenios internacionales que regulan los derechos y obligaciones tanto de empleadores
